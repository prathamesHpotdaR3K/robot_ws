...
: ${AMENT_CURRENT_PREFIX:="/home/prathamesh/robot_ws/install/robot_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_bringup/environment/pythonpath.sh"
